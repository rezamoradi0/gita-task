...
function PopupFull({ children, closeFun, headerText }) {
  return createPortal(
    <div className="absolute left-0 top-0 flex h-screen w-screen flex-col items-center justify-center overflow-hidden">
      <div className="fixed left-1/2  top-1/2 z-50 h-fit w-max -translate-x-1/2  -translate-y-1/2 flex-col  justify-center rounded-lg  border p-16  dark:bg-primary-dark dark:text-secondary-dark">
      <Button
            onClick={closeFun}
